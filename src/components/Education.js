...
function Education() {
  return (
    <>
      <div className="animate__animated animate__fadeIn p-4 flex flex-col  md:gap-8 gap-4">
      <div className="flex  justify-between items-start  ">
        <div className="flex flex-col justify-between items-start w-1/2">
          <h1 className="text-sm md:text-3xl text-red-400">Bachelor of Technology-ECE</h1>
          <h2 className="text-xs md:text-2xl text-[#ccd6f6]">Jaypee Institute of Information Technology</h2>
        </div>
      ...
      <div className="flex  justify-between items-start">
        <div className="flex flex-col justify-between items-start w-1/2">
          <h1 className="text-sm md:text-3xl text-red-400">Senior Secondary (XII), Science</h1>
          <h2 className="text-xs md:text-2xl  text-[#ccd6f6]">Janki Devi Public School</h2>
        </div>
      ...
      <div className="flex  justify-between items-start">
        <div className="flex flex-col justify-between items-start w-1/2">
          <h1 className="text-sm md:text-3xl text-red-400">Secondary (X)</h1>
          <h2 className="text-xs md:text-2xl text-[#ccd6f6]">Janki Devi Public School</h2>
        </div>
        <div className="flex flex-col justify-between h-full gap-3 items-start w-1/2">
          <p className="w-full flex justify-end items-center gap-2 text-xs md:text-xl text-[#ccd6f6]">
